...
export const validateTaxForm = (
  ...
  switch (step) {
    case 0: // Tax Year Step
      ...
      if (isEmpty(ty.year)) {
        setError(
          section,
          "year",
          validationMessages?.taxYear?.required || "Tax year is required",
        );
      }
      break;
    ...
    case 1: // Personal Info Step
      ...
      if (!isValidDate(pi.dateOfBirth))
        setError(section, "dateOfBirth", "invalidDate");
      if (isEmpty(pi.maritalStatus))
        setError(section, "maritalStatus", "selectionRequired");

      // Optional fields with format validation
      if (pi.email && !isValidEmail(pi.email))
        setError(section, "email", "invalidEmail");
      if (pi.phone && !isValidPhone(pi.phone))
        setError(section, "phone", "invalidPhone");

      // Address (all fields mandatory)
      if (isEmpty(pi.address?.street))
        setError(section, "address.street", "required");
      if (isEmpty(pi.address?.houseNumber))
        setError(section, "address.houseNumber", "required");
      if (!isValidPostalCode(pi.address?.postalCode))
        setError(section, "address.postalCode", "invalidPostalCode");
      if (isEmpty(pi.address?.city))
        setError(section, "address.city", "required");
      ...
      if (pi.hasForeignResidence === undefined) {
        ...
        if (
          pi.foreignResidence?.country === "other" &&
          isEmpty(pi.foreignResidence?.otherCountry)
        ) {
      ...
      const requiresSpouseInfo =
        pi.maritalStatus === "married" ||
        pi.maritalStatus === "registered_partnership";
      if (requiresSpouseInfo) {
        if (isEmpty(pi.spouse?.firstName))
          setError(section, "spouse.firstName", "required");
        if (isEmpty(pi.spouse?.lastName))
          setError(section, "spouse.lastName", "required");
        if (!isValidDate(pi.spouse?.dateOfBirth))
          setError(section, "spouse.dateOfBirth", "invalidDate");
        if (!isValidTaxId(pi.spouse?.taxId))
          setError(section, "spouse.taxId", "invalidTaxId");
    ...
    case 2: // Income Info Step
      ...
      if (ii.employment?.isEmployed === undefined) {
        ...
        if (ii.employment?.hasTaxCertificate === undefined) {
          ...
          if (
            !ii.employment?.taxCertificate ||
            !Array.isArray(ii.employment?.taxCertificate) ||
            ii.employment?.taxCertificate.length === 0
          ) {
    ...
    case 3: // Rental Income Step
      ...
      if (ri.hasRentalProperty === undefined) {
        ...
        if (!isValidPostalCode(address.postalCode)) {
          setError(
            section,
            "rentalPropertyAddress.postalCode",
            "invalidPostalCode",
          );
        }
    ...
    case 4: // Foreign Income Step
      ...
      if (fi.hasForeignIncome === undefined) {
        ...
        // Tax Certificate validation
        if (
          !fi.foreignIncomeTaxCertificateFile ||
          (Array.isArray(fi.foreignIncomeTaxCertificateFile) &&
            fi.foreignIncomeTaxCertificateFile.length === 0)
        ) {
    ...
    case 5: // Work-Related Expenses Step
      ...
      if (
        wrExpenses.workRelatedExpenses?.commutation?.hasCommutingExpenses ===
        undefined
      ) {
        setError(
          section,
          "workRelatedExpenses.commutation.hasCommutingExpenses",
          "selectionRequired",
        );
      } else if (
        wrExpenses.workRelatedExpenses?.commutation?.hasCommutingExpenses ===
        ...
        if (
          isEmpty(wrExpenses.workRelatedExpenses?.commutation?.workingDaysCount)
        ) {
          setError(
            section,
          ...
          !isValidWorkingDays(
            Number(
              wrExpenses.workRelatedExpenses?.commutation?.workingDaysCount,
            ),
          )
        ) {
          setError(
        ...
        if (
          !isValidAddress(
            wrExpenses.workRelatedExpenses?.commutation?.route?.from,
          )
        ) {
          setError(
            section,
            "workRelatedExpenses.commutation.route.from",
            "invalidAddress",
          );
        }
        ...
        if (
          !isValidAddress(
            wrExpenses.workRelatedExpenses?.commutation?.route
              ?.firstOfficeAddress,
          )
        ) {
          setError(
            section,
            "workRelatedExpenses.commutation.route.firstOfficeAddress",
            "invalidAddress",
          );
        }
      }
      ...
      if (
        Number(wrExpenses.workRelatedExpenses?.businessTripsCosts?.amount) > 0
      ) {
        if (
          !wrExpenses.workRelatedExpenses?.businessTripsCosts?.proof ||
          !Array.isArray(
            wrExpenses.workRelatedExpenses?.businessTripsCosts?.proof,
          ) ||
          ...
          setError(
            section,
            "workRelatedExpenses.businessTripsCosts.proof",
            "fileRequired",
          );
        }
      }
      ...
      if (
        wrExpenses.workRelatedExpenses?.workEquipment?.hasWorkEquipment ===
        undefined
      ) {
        setError(
          section,
          "workRelatedExpenses.workEquipment.hasWorkEquipment",
          "selectionRequired",
        );
      }
      ...
      if (
        wrExpenses.workRelatedExpenses?.homeOffice?.hasHomeOffice === undefined
      ) {
        setError(
          section,
          "workRelatedExpenses.homeOffice.hasHomeOffice",
          "selectionRequired",
        );
      } else if (
        wrExpenses.workRelatedExpenses?.homeOffice?.hasHomeOffice === true
      ) {
        if (
          isEmpty(wrExpenses.workRelatedExpenses?.homeOffice?.workingDaysCount)
        ) {
          setError(
            section,
          ...
          !isValidWorkingDays(
            Number(
              wrExpenses.workRelatedExpenses?.homeOffice?.workingDaysCount,
            ),
          )
        ) {
          setError(
      ...
      if (
        wrExpenses.workRelatedExpenses?.hasDoubleHouseholdMgmt === undefined
      ) {
        setError(
          section,
          "workRelatedExpenses.hasDoubleHouseholdMgmt",
          "selectionRequired",
        );
      }
      break;
    ...
    case 6: // Special Expenses Step
      ...
      if (
        specialExpenses.specialExpenses?.insurance?.hasInsurance === undefined
      ) {
        setError(
          section,
          "specialExpenses.insurance.hasInsurance",
          "selectionRequired",
        );
      }
      ...
      if (
        specialExpenses.specialExpenses?.donations?.hasDonations === undefined
      ) {
        setError(
          section,
          "specialExpenses.donations.hasDonations",
          "selectionRequired",
        );
      }
      ...
      if (
        specialExpenses.specialExpenses?.professionalDevelopment
          ?.hasProfessionalDevelopment === undefined
      ) {
        setError(
          section,
          "specialExpenses.professionalDevelopment.hasProfessionalDevelopment",
          "selectionRequired",
        );
      }
      break;
    ...
    case 7: // Extraordinary Burdens Step
      ...
      if (
        extraBurdens.extraordinaryBurdens?.medicalExpenses
          ?.hasMedicalExpenses === undefined
      ) {
        setError(
          section,
          "extraordinaryBurdens.medicalExpenses.hasMedicalExpenses",
          "selectionRequired",
        );
      }
      ...
      if (
        extraBurdens.extraordinaryBurdens?.careCosts?.hasCareCosts === undefined
      ) {
        setError(
          section,
          "extraordinaryBurdens.careCosts.hasCareCosts",
          "selectionRequired",
        );
      }
      ...
      if (
        extraBurdens.extraordinaryBurdens?.disabilityExpenses
          ?.hasDisabilityExpenses === undefined
      ) {
        setError(
          section,
          "extraordinaryBurdens.disabilityExpenses.hasDisabilityExpenses",
          "selectionRequired",
        );
      }
      break;
    ...
    case 8: // Craftsmen Services Step
      ...
      if (
        craftsmenServices.craftsmenServices?.hasMaintenancePayments ===
        undefined
      ) {
        setError(
          section,
          "craftsmenServices.hasMaintenancePayments",
          "selectionRequired",
        );
      } else if (
        craftsmenServices.craftsmenServices?.hasMaintenancePayments === true
      ) {
        // Maintenance Recipient validation
        if (
          isEmpty(craftsmenServices.craftsmenServices?.maintenanceRecipient)
        ) {
          setError(
            section,
        ...
        if (isEmpty(craftsmenServices.craftsmenServices?.maintenanceAmount)) {
          ...
          !isValidAmount(
            Number(craftsmenServices.craftsmenServices?.maintenanceAmount),
          )
        ) {
          setError(
            section,
            "craftsmenServices.maintenanceAmount",
            "invalidAmount",
          );
        }
        ...
        // Invoice validation
        if (
          !craftsmenServices.craftsmenServices?.invoiceCraftsmenServices ||
          !Array.isArray(
            craftsmenServices.craftsmenServices?.invoiceCraftsmenServices,
          ) ||
          craftsmenServices.craftsmenServices?.invoiceCraftsmenServices
          ...
          setError(
            section,
            "craftsmenServices.invoiceCraftsmenServices",
            "fileRequired",
          );
        }
      }
