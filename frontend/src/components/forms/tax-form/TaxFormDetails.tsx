...
const FileDisplay = ({
  ...
  const downloadFile = () => {
    ...
    const filename =
      value.split("/").pop() || `${fileType.replace(/\s+/g, "_")}.pdf`;
      ...
      <div className="min-h-screen flex justify-center items-center bg-neutral-50 p-4">
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md text-center">
          ...
          <p className="text-neutral-700 mb-4">
            We couldn't find the tax form you're looking for.
          </p>
          <button
            onClick={handleBack}
            className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700"
      ...
      <div className="w-full max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-end">
              ...
              >
                {formData.status?.charAt(0).toUpperCase() +
                  formData.status?.slice(1) || "Unknown Status"}
              </span>
        ...
        <div className="space-y-6 bg-white p-6 rounded-lg shadow-md border border-neutral-200">
          ...
          <FormSection title="Personal Information">
            ...
            />
            <DataRow
              label="Has Foreign Residence"
              value={formatBoolean(personalInfo.hasForeignResidence)}
            />

            {personalInfo.hasForeignResidence &&
              personalInfo.foreignResidence && (
                <DataRow
                  label="Foreign Residence Country"
            ...
            {personalInfo.hasSpouse && personalInfo.spouse && (
              <>
                ...
                <DataRow
                  label="Date of Birth"
                  value={formatDate(personalInfo.spouse.dateOfBirth)}
                />
            ...
            {personalInfo.hasChildren &&
              ...
              personalInfo.children.length > 0 && (
                <>
          ...
          <FormSection title="Income Information">
                  ...
                  <>
                    ...
                    <DataRow
                      ...
                      value={formatCurrency(
                        incomeInfo.employment.employmentIncome,
                      )}
                    />
                    <DataRow
                      label="Has Tax Certificate"
                      value={formatBoolean(
                        incomeInfo.employment.hasTaxCertificate,
                      )}
                    />
                    <DataRow
                      label="Has Travel Subsidy"
                      value={formatBoolean(
                        incomeInfo.employment.hasTravelSubsidy,
                      )}
                    />
                    <DataRow
                    ...
                    {incomeInfo.employment.hasTaxCertificate &&
                      incomeInfo.employment.taxCertificate &&
                      incomeInfo.employment.taxCertificate.length > 0 && (
                        <FileDisplay
                          label="Tax Certificate"
                          value={
                            incomeInfo.employment.taxCertificate[0]?.url || ""
                          }
            ...
            {incomeInfo.hasForeignIncome && (
              <>
                ...
                <DataRow
                  label="Has Foreign Income"
                  value={formatBoolean(incomeInfo.hasForeignIncome)}
                />
                <DataRow
                  label="Foreign Country"
                  value={incomeInfo.foreignIncomeCountry}
                />
                {incomeInfo.foreignIncomeOtherCountry && (
                  <DataRow
                    label="Other Foreign Country"
                    value={incomeInfo.foreignIncomeOtherCountry}
                  />
                )}
                <DataRow
                  label="Foreign Income Type"
                ...
                {incomeInfo.foreignIncomeTaxCertificateFile &&
                  incomeInfo.foreignIncomeTaxCertificateFile.length > 0 && (
                    <FileDisplay
                      label="Foreign Income Tax Certificate"
                      value={
                        incomeInfo.foreignIncomeTaxCertificateFile[0]?.url || ""
                      }
          ...
          {(Object.keys(workRelatedExpenses).length > 0 ||
            (expenses &&
              Object.keys(expenses.workRelatedExpenses || {}).length > 0)) && (
            <FormSection title="Work-Related Expenses">
              {/* Use either the top-level workRelatedExpenses or the one nested under expenses */}
              {(() => {
                const workExpenses =
                  workRelatedExpenses || expenses.workRelatedExpenses || {};
                ...
                return (
                  <>
                        ...
                        {workExpenses.commutation.hasCommutingExpenses && (
                          <>
                            <DataRow
                              ...
                              value={workExpenses.commutation.workingDaysCount}
                            />
                                ...
                                {workExpenses.commutation.route.from && (
                                  <>
                                    ...
                                    <DataRow
                                      ...
                                      value={
                                        workExpenses.commutation.route.from.city
                                      }
                                    />
                                  </>
                                )}
                                ...
                                {workExpenses.commutation.route
                                  ...
                                  <>
                                    <DataRow
                                      ...
                                      value={
                                        workExpenses.commutation.route
                                          .firstOfficeAddress.street
                                      }
                                    />
                                    <DataRow
                                      label="Office Address House Number"
                                      value={
                                        workExpenses.commutation.route
                                          .firstOfficeAddress.houseNumber
                                      }
                                    />
                                    <DataRow
                    ...
                    {workExpenses.businessTripsCosts && (
                      <>
                        ...
                        <DataRow
                          label="Amount"
                          value={formatCurrency(
                            workExpenses.businessTripsCosts.amount,
                          )}
                        />

                        {workExpenses.businessTripsCosts.proof &&
                          workExpenses.businessTripsCosts.proof.length > 0 && (
                            <FileDisplay
                              label="Business Trips Proof"
                              value={
                                workExpenses.businessTripsCosts.proof[0]?.url ||
                                ""
                              }
                    ...
                    {/* Work Equipment */}
                    {workExpenses.workEquipment &&
                      workExpenses.workEquipment.hasWorkEquipment && (
                        <>
                          <SubHeading text="Work Equipment" />
                          <DataRow
                            label="Has Work Equipment"
                            value={formatBoolean(
                              workExpenses.workEquipment.hasWorkEquipment,
                            )}
                          />

                          {workExpenses.workEquipment.expenses &&
                            workExpenses.workEquipment.expenses.length > 0 && (
                              <>
                                {workExpenses.workEquipment.expenses.map(
                                  (item: any, index: number) => (
                                    <React.Fragment key={item.id || index}>
                                      <SubHeading
                                        text={`Equipment ${index + 1}: ${item.description || "Work Equipment"}`}
                                      />
                    ...
                    {workExpenses.homeOffice && (
                      <>
                        ...
                        {workExpenses.homeOffice.hasHomeOffice && (
                          <DataRow
                            label="Working Days Count"
                            value={workExpenses.homeOffice.workingDaysCount}
                          />
                        )}
                      </>
                    )}
                    ...
                    {workExpenses.applicationCosts && (
                      <>
                        ...
                        <DataRow
                          ...
                          value={formatCurrency(
                            workExpenses.applicationCosts.online,
                          )}
                        />
                        <DataRow
                          label="In-Person Applications"
                          value={formatCurrency(
                            workExpenses.applicationCosts.inPerson,
                          )}
                        />
                      </>
                    )}
                    ...
                    <DataRow
                      label="Has Double Household Management"
                      value={formatBoolean(workExpenses.hasDoubleHouseholdMgmt)}
                    />
                  </>
                );
              })()}
          ...
          {(Object.keys(specialExpenses).length > 0 ||
            (expenses &&
              Object.keys(expenses.specialExpenses || {}).length > 0)) && (
            <FormSection title="Special Expenses">
              {(() => {
                const specExpenses =
                  specialExpenses || expenses.specialExpenses || {};
                  ...
                  <>
                    ...
                    {specExpenses.insurance && (
                      <>
                        ...
                        <DataRow
                          label="Has Insurance"
                          value={formatBoolean(
                            specExpenses.insurance.hasInsurance,
                          )}
                        />

                        {specExpenses.insurance.hasInsurance &&
                          specExpenses.insurance.expenses &&
                          specExpenses.insurance.expenses.length > 0 && (
                            <>
                              {specExpenses.insurance.expenses.map(
                                (item: any, index: number) => (
                                  <React.Fragment key={item.id || index}>
                                    <SubHeading
                                      text={`Insurance ${index + 1}: ${item.description || "Insurance"}`}
                                    />
                                    <DataRow label="Type" value={item.type} />
                                    <DataRow
                                      label="Amount"
                    ...
                    {specExpenses.donations && (
                      <>
                        ...
                        <DataRow
                          label="Has Donations"
                          value={formatBoolean(
                            specExpenses.donations.hasDonations,
                          )}
                        />
                      </>
                    )}
                    ...
                    {specExpenses.professionalDevelopment && (
                      <>
                        ...
                        <DataRow
                          label="Has Professional Development"
                          value={formatBoolean(
                            specExpenses.professionalDevelopment
          ...
          {(Object.keys(extraordinaryBurdens).length > 0 ||
            (expenses &&
              Object.keys(expenses.extraordinaryBurdens || {}).length > 0)) && (
            <FormSection title="Extraordinary Burdens">
              {(() => {
                const extraBurdens =
                  extraordinaryBurdens || expenses.extraordinaryBurdens || {};
                  ...
                  <>
                    ...
                    {extraBurdens.medicalExpenses && (
                      <>
                        ...
                        <DataRow
                          label="Has Medical Expenses"
                          value={formatBoolean(
                            extraBurdens.medicalExpenses.hasMedicalExpenses,
                          )}
                        />

                        {extraBurdens.medicalExpenses.hasMedicalExpenses &&
                          extraBurdens.medicalExpenses.expenses &&
                          extraBurdens.medicalExpenses.expenses.length > 0 && (
                            <>
                              {extraBurdens.medicalExpenses.expenses.map(
                                (item: any, index: number) => (
                                  <React.Fragment key={item.id || index}>
                                    <SubHeading
                                      text={`Medical Expense ${index + 1}: ${item.description || "Medical Expense"}`}
                                    />
                                    <DataRow label="Type" value={item.type} />
                                    <DataRow
                                      label="Amount"
                    ...
                    {extraBurdens.careCosts && (
                      <>
                        ...
                        <DataRow
                          label="Has Care Costs"
                          value={formatBoolean(
                            extraBurdens.careCosts.hasCareCosts,
                          )}
                        />
                      </>
                    )}
                    ...
                    {extraBurdens.disabilityExpenses && (
                      <>
                        ...
                        <DataRow
                          label="Has Disability Expenses"
                          value={formatBoolean(
                            extraBurdens.disabilityExpenses
                              .hasDisabilityExpenses,
                          )}
                        />
                      </>
                    )}
          ...
          {(Object.keys(craftsmenServices).length > 0 ||
            (expenses &&
              Object.keys(expenses.craftsmenServices || {}).length > 0)) && (
            <FormSection title="Craftsmen Services">
              {(() => {
                const craftServices =
                  craftsmenServices || expenses.craftsmenServices || {};

                return (
                  <DataRow
                    label="Has Maintenance Payments"
                    value={formatBoolean(craftServices.hasMaintenancePayments)}
                  />
                );
              })()}
            </FormSection>
          ...
          <FormSection title="Signature">
            ...
            <DataRow
              ...
              value={formatBoolean(signature.confirmSignature)}
            />

            {signature.signature && (
              <div className="md:col-span-2 mb-2">
                <div className="font-bold text-sm text-neutral-800 mb-1">
                  Digital Signature
                </div>
