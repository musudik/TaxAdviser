    ...
    <div className="min-h-screen bg-neutral-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-medium text-neutral-900 font-['Switzer-Medium']">
            German Tax Return
          </h1>
          <p className="mt-2 text-lg text-neutral-600 font-['Switzer-Regular']">
            Complete the form below to submit your tax return
          </p>
        </div>
