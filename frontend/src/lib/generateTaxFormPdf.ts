...
declare global {
  ...
  interface ImportMetaEnv {
    TA_VITE_FIREBASE_STORAGE_BUCKET: string;
    TA_VITE_FIREBASE_API_KEY: string;
    TA_VITE_FIREBASE_AUTH_DOMAIN: string;
    TA_VITE_FIREBASE_PROJECT_ID: string;
    TA_VITE_FIREBASE_MESSAGING_SENDER_ID: string;
    TA_VITE_FIREBASE_APP_ID: string;
  }
}
...
const firebaseConfig = {
  apiKey: import.meta.env.TA_VITE_FIREBASE_API_KEY,
  authDomain: import.meta.env.TA_VITE_FIREBASE_AUTH_DOMAIN,
  projectId: import.meta.env.TA_VITE_FIREBASE_PROJECT_ID,
  storageBucket: import.meta.env.TA_VITE_FIREBASE_STORAGE_BUCKET,
  messagingSenderId: import.meta.env.TA_VITE_FIREBASE_MESSAGING_SENDER_ID,
  appId: import.meta.env.TA_VITE_FIREBASE_APP_ID,
};
